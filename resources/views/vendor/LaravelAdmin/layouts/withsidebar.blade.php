...
<html lang="en">
    <head>
        ...
        <link href="{{ asset('assets/vendor/laravelAdmin/css/vendors.css') }}" rel="stylesheet">
        <link href="{{ asset('assets/vendor/laravelAdmin/css/app.css') }}" rel="stylesheet">
        @yield('styles')
        <!-- Fonts -->
    ...
    <body class="skin-blue sidebar-mini">
        ...
        <script src="{{ asset('assets/vendor/laravelAdmin/js/all.js') }}"></script>
        @yield('scripts')
    </body>
</html>
